...
When referencing issues in written communication using just the issue number `#123456` and a link is not [low-context communication](/handbook/communication/#low-context). Instead use the title of the issue and the link or the issue number and description of the problem that issue will solve:
...
### End-of-Line Testing Communication

When conducting [End-of-Line testing](/handbook/engineering/devops/plan/#internal-testing) that may impact internal workflows or customer-facing demonstrations, product teams should coordinate internal announcements to avoid surprises for field team members who demo to customers.

#### End-of-Line Communication Guidelines

- Internal announcement should precede End-of-Line Testing. Some suggested locations for the announcement and for cross-posting are the Slack channels: `#whats-happening-at-gitlab`, `#product`, `#customer-success`, `#solution-architects`.
- Coordinate with field teams who may be impacted during customer demonstrations
- Use appropriate communication channels based on the scope of impact

#### Responsibility

This communication is a product-led responsibility, with product managers coordinating with their engineering counterparts to ensure appropriate stakeholder notification.
...
See [Rate Limiting::Managing Limits](/handbook/engineering/infrastructure-platforms/rate-limiting/managing-limits/).
...
See the [Cross-Functional Prioritization page](/handbook/product/product-processes/cross-functional-prioritization/) for more information.
...
1. During (see an [example session recording](https://youtu.be/xgeXUEzOpUY)):
   1. The facilitator starts [recording the call](/handbook/security/corporate/end-user-services/supported-apps/zoom/zoom-recording).
...
- Refer to [research participant gratuities](/handbook/product/ux/ux-research-coordination/participation-gratuities/) section to understand [if your study qualifies for incentive distribution](/handbook/product/ux/ux-research-coordination/participation-gratuities/).
...
- [Strategic Priority Codes](/handbook/engineering/strategic-priority-codes/) - use when critical situations require immediate attention from various stakeholders across the Engineering Division
...
If it is the weekend, and the contact request is urgent as a result of an action that might affect a users' usage of GitLab, [page the CMOC](/handbook/engineering/infrastructure-platforms/incident-management/#how-to-engage-response-teams)
...
Twice a year, we reach out to [User Satisfaction (USAT+)](/handbook/product/ux/performance-indicators/usat-plus/) survey responders who opted-in to speak with us. This is a fantastic opportunity to build bridges with end users and for Product Managers and Product Designers to get direct feedback for their specific product area. If a user has taken the time to share a verbatim with us and offered to have a conversation, they deserve to be followed up with - especially if that user is dissatisfied with GitLab.
...
1. UX Researcher DRI opens a USAT+ Responder Outreach issue and notifies Product team members in the comments that the issue is ready.
...
1. Product team members reach out to users to schedule interviews or gather more feedback via email.
1. Product team members add video recordings from the interviews to the `USAT+` column in this [Dovetail project](https://gitlab.dovetailapp.com/projects/36nmGVKvkaT7SGMXtUeHVg/v/70xPTo5RzTRZnCNEVz1fWH).
...
#### Process for gathering additional feedback via email
...
> Subject: Following up on your [Product/Feature Name] feedback
>
> Hello [Name],
>
> Thank you for taking the time to share your feedback in our recent survey about [specific feature/area]. I'm [Your Name], the [Product Manager/Designer] for [Product/Feature] at GitLab, and I read through your response with interest.
>
> You mentioned [1-2 specific points from their survey response]. I'd love to understand this better so we can improve the experience for you and others.
>
> If you have a few minutes, could you help me understand:
>
> - [Specific question related to their feedback]
> - [Specific question about context or impact]
> - [Optional: Ask about what would make it better]
>
> Feel free to respond directly to this email with whatever level of detail works for you—even a few sentences would be incredibly valuable.
>
> Thank you again for helping us build a better product. Your perspective as a [customer/user] directly shapes what we prioritize.
>
> Best,
> [Your Name]
> [Your Title] • GitLab

#### Process for scheduling follow up interviews with users
...
> Subject: Would you be open to a 30-minute conversation about [Product/Feature]?
>
> Hello [Name],
>
> Thank you for sharing your thoughts in our recent survey about [specific feature/area]. I'm [Your Name], the [Product Manager/Designer] for [Product/Feature] at GitLab, and your feedback really stood out to me.
>
> You mentioned [1-2 specific points from their survey response], and I'd love to dig deeper into your experience. A conversation would help me understand the full context and ensure we're addressing what matters most to users like you.
>
> **What we'd cover in 30 minutes:**
> Your current workflow with [feature/product]
> The specific challenges or friction points you've encountered
> What would make your experience better
>
> These conversations directly inform our roadmap, and I find them far more valuable than any amount of analytics data. If you're open to it, you can choose a time that works for you here:
>
> **Schedule a call:** https://calendly.com/yourname/30min
>
> No pressure if the timing doesn't work—I know you're busy. Either way, thank you for taking the time to give us feedback.
>
> Best,
> [Your Name]
> [Your Title] • GitLab
