export default {
  ...
  kag: {
    ...
    form: {
      ...
      llmConfigId: 'LLM 配置',
      llmConfigIdPlaceholder: '请选择 LLM 配置',
      embeddingConfigId: 'Embedding 配置',
      embeddingConfigIdPlaceholder: '请选择 Embedding 配置',
      promptId: 'Prompt 配置',
      promptIdPlaceholder: '请选择 Prompt 配置',
      extractionRounds: '抽取轮数',
      llmConfigIdOverride: 'LLM 配置 (覆盖全局)',
      embeddingConfigIdOverride: 'Embedding 配置 (覆盖全局)',
      algorithmType: '算法类型',
    },
    ...
    tab: {
      ...
      tripleRefinement: '三元组精炼',
      predicateRefinement: '谓词精炼',
      graphDb: '图数据库',
    },
    button: {
      save: '保存配置',
